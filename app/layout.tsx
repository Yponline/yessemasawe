...
export const metadata: Metadata = {
	...
	description:
		"Experienced full-stack developer specializing in Next.js, React, TypeScript, Tailwind CSS. Building fast, modern web applications and freelance projects in Tanzania and remotely. Available for hire.",
	keywords: [
	...
	openGraph: {
		...
		description:
			"Creating performant web experiences with Next.js, React & modern tools. Freelance & remote projects welcome.",
	...
	twitter: {
		...
		description:
			"Freelance full-stack developer based in Dar es Salaam – open for projects.",
		images: ["/og-image.jpg"],
	},
